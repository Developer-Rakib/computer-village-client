...
const NewsLetter = () => {
    ...
    return (
        <div className='mb-20 mt-10'>
            {/* <h1 className="text-4xl border-b-4  mb-3 mt-4 border-primary inline-block">News Letter</h1> */}
            <div style={{ backgroundImage: 'url("https://dlcdnimgs.asus.com/websites/global/products/eZwnQPTSRcn68Lwd/img/kv/OPTIMIZATION_banner.jpg")', fontFamily: 'Oswald' }} className='h-[400px] bg-center bg-cover mb-16 w-full flex justify-center items-center text-white Container'>
                <div>
                    ...
                    <form onSubmit={handleSubmit} style={{ fontFamily: 'Open Sans,sans-serif' }} >
                        <input className='h-12 w-6/12 px-5 mx-auto border-2 bg-inherit rounded-full' type="email" name="email" id="" placeholder='Enter Email' required />
                        <button type='submit' style={{ fontFamily: 'Open Sans, sans-serif', letterSpacing: '2px' }} class="hover:bg-white transition w-40 mx-auto text-center bg-primary  hover:text-primary rounded-full text-white border-2 border-primary py-2.5 ml-[-40px]">Subscribe</button>
                    </form>
                </div>
            </div>
        </div>
