        ...
        <div style={{backgroundImage:`url(${banner})`, height:"90vh", backgroundSize:'cover', backgroundRepeat:"no-repeat", backgroundPosition:'center'}} className='flex items-center mt-[66px]'>
            <div className='Container'>
                <div className='text-left w-8/12'>
                    <h1 className="text-7xl text-primary font-bold">Computer Village</h1>
                    ...
                    <button style={{fontFamily:'Open Sans, sans-serif', letterSpacing:'2px'}} className='uppercase bg-primary border-2 border-primary hover:bg-white hover:text-primary duration-200 rounded-full text-white px-12 py-2'>see more</button>
                </div>
            </div>
        </div>
    );
