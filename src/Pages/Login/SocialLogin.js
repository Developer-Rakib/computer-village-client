    ...
    return (
        <div>
            ...
            style={{fontFamily:'Open Sans, sans-serif', letterSpacing:'1px'}} 
                ...
                class="hover:bg-primary transition font-semibold text-center hover:text-white rounded-md text-primary border border-primary  py-2 w-full">
                {loading ?
                    <svg role="status" class="w-8 h-8 mx-auto  text-gray-200 animate-spin dark:text-gray-600 fill-orange-600" viewBox="0 0 100 101" fill="none" xmlns="http://www.w3.org/2000/svg">
