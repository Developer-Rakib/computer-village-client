...
const Header = () => {
    ...
    return (
        <div className='header-container fixed top-0 w-full'>
            <nav
                className='flex justify-start items-start  md:justify-between py- md:px-32 px-5 md:items-center'
            >
                <img className='sm:w-64 w-48' src={logo} alt="" />
                ...
                <ul onClick={navBtnHndle} className={`flex flex-col text-center md:justify-end z-10  md:flex-row md:top-0 left-0 w-full md:relative md:opacity-100  absolute  py-4 md:py-0 duration-500 ${toggle ? " opacity-100  top-16"  : " top-[-150px] opacity-0"}`}>
